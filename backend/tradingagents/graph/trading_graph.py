...
from tradingagents.agents.utils.agent_utils import get_stock_data, get_indicators, get_fundamentals, get_balance_sheet, get_cashflow, get_income_statement, get_news, get_insider_sentiment, get_insider_transactions, get_global_news
...
class TradingAgentsGraph:
    ...
    def _log_state(self, trade_date, final_state):
        ...
        self.log_states_dict[str(trade_date)] = {
            ...
            "momentum_report": final_state["momentum_report"],  # new agent
        ...
        # Save to file
        directory = Path(f"results/{self.ticker}/")
        directory.mkdir(parents=True, exist_ok=True)

        with open(
            f"results/{self.ticker}/full_states_log_{trade_date}.json",
            "w",
        ) as f:
